    ...
    const handleBackgroundChange = (e) => {
      ...
      const addFood = () => {
        setFood((prev) => [
          ...prev,
          {
            name: document.querySelector('input[placeholder="Name of the food"]').value,
            description: document.querySelector('input[placeholder="Description of the food"]').value,
            price: document.querySelector('input[placeholder="Price of the food"]').value,
            image: foodImagePreview,
          },
        ]);

        // Reset the input fields after adding a food item
