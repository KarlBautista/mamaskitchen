...
const StartSelling = () => {
  ...
  const handleChange = (e) => {
    ...
    const handleClick = async (e) => {
      ...
      formData.append("business_logo", businessLogo); // File input
      formData.append("business_background", businessBackground); // File input
        ...
        <div className="step-1-container">
          <div className="step-1">
            ...
            <div className="form-group">
              ...
              <input type="file" accept="image/*" onChange={handleChange} name="business_logo" value={handleLogoChange} />
            </div>
            <div className="form-group">
              <label>Business Background</label>
                <input type="file" accept="image/*" onChange={handleChange} name="business_background" value={handleBackgroundChange}/>
              </div>
          </div>
