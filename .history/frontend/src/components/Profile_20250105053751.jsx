    ...
    const handleDeleteAccount = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.delete("http://localhost:8800/delete_user", {
                        data: { user_id: user.id }, // Assuming user has an id field
                    });
                    ...
                    if (response.data.success) {
                        ...
                        // Redirect to a different page (e.g., home or login page)
