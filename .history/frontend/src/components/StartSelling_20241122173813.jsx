        ...
        <div className="step-2-container">
          <div className="step-2">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Name of the food" id="food-name" onChange={foodHandleChange} name="food_name"/>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Price of the food" id="food-price" onChange={}/>
            </div>
            <div className="form-group">
