...
const StartSelling = () => {
  ...
  const handleClick = async (e) => {
    ...
    try{
      await axios.post("http://localhost:8800/stores_account", storeInfo);
        ...
        <div className="step-1-container">
          <div className="step-1">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Name of your store" onChange={handleChange} name="business_name" value={storeInfo.businessName}/>
            </div>

            <div className="form-group">
              <label htmlFor="">Business Category</label>
              <select name="business-category" id="buisness-category" onChange={handleChange} name="business_category" value={storeInfo.businessCategory}>
            ...
            <div className="form-group">
              ...
              <input type="file" accept="image/*" onChange={handleChange} name="business_logo" value={business_logo} />
            </div>
            <div className="form-group">
              <label>Business Background</label>
              <input type="file" accept="image/*" onChange={handleChange} name="business_background" value={business_background}/>
            </div>
          </div>
