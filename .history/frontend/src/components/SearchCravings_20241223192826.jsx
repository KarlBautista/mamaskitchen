        ...
        <ul className="food-class">
            ...
            <div className="main-container">
                ...
                <div className="card-foods">
                        ...
                        <div className="card-foods">
                            <img src={lumpiangShanghai} alt="LumpiangShanghai" />
                            <div className="card-details">
                                <p className="dish-name">Lumpiang Shanghai</p>
                                <p className="dish-price">₱120</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            <img src={Pansit} alt="Lechon" />
                            <div className="card-details">
                                <p className="dish-name">Pansit</p>
                                <p className="dish-price">₱150</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            <img src={Pinakbet} alt="Pinakbet" />
                            <div className="card-details">
                                <p className="dish-name">Pinakbet</p>
                                <p className="dish-price">₱120</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            ...
                            <div className="card-details">
                                <p className="dish-name">Sinigang</p>
                                <p className="dish-price">₱250</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            ...
                            <div className="card-details">
                                <p className="dish-name">Spaghetti</p>
                                <p className="dish-price">₱150</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            <img src={TinolangManok} alt="Spaghetti" />
                            <div className="card-details">
                                <p className="dish-name">Tinolang Manok</p>
                                <p className="dish-price">₱200</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            ...
                            <div className="card-details">
                                <p className="dish-name">Torta</p>
                                <p className="dish-price">₱120</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            <img src={UbeHalaya} alt="Torta" />
                            <div className="card-details">
                                <p className="dish-name">Ube Halaya</p>
                                <p className="dish-price">₱150</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
                        <div className="card-foods">
                            <img src={LecheFlan} alt="Torta" />
                            <div className="card-details">
                                <p className="dish-name">Leche Flan</p>
                                <p className="dish-price">₱200</p>
                                <button className="add-to-cart"><i className="fa-solid fa-cart-shopping"></i></button>
                            </div>
                        </div>
