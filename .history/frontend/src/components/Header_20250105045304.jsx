    ...
    return (
        ...
        >
            ...
            <div className="header-links">
                {user?.user_type === "admin" ? (
                    <>
                        ...
                        <Link
                            to="/adminMenu"
                            className={activeLink === "/adminMenu" ? "active" : ""}
                            onClick={() => handleLinkClick("/adminMenu")}
                        >
                            Menu
                        </Link>
                        <Link
            ...
            <div className="header-last">
                {/* Display the cart icon only if the user is not an admin */}
                {user?.user_type !== "admin" && (
                    <Link
                        to="/cart"
                    ...
                    {isDropdownOpen && (
                       ...
                       {user ? (
                           <>
                               ...
                               {/* Conditionally render Order History based on user type */}
                               {user?.user_type !== "admin" && (
                                   <span
