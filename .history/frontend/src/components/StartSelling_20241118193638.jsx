...
const StartSelling = () => {
  ...
  const handleClick = async (e) => {
    ...
    formData.append("business_logo", document.querySelector('input[name="business_logo"]').files[0]);
    formData.append("business_background", document.querySelector('input[name="business_background"]').files[0]);
        ...
        <div className="step-1-container">
          <div className="step-1">
            ...
            <div className="form-group">
              ...
              <select name="business-category" id="buisness-category" onChange={handleChange}  value={storeInfo.businessCategory}>
            ...
            <div className="form-group">
              ...
              <input type="file" accept="image/*" onChange={handleChange} name="business_logo" value={storeInfo.business_logo} />
            </div>
            <div className="form-group">
