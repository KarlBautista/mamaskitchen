...
const StartSelling = () => {
  ...
  const addFood = (prev) =>{
    ...
    const foodCategory = document.getElementsByClassName("food-category").value;
    const foodPrice = document.getElementById("food-price").value;

    if(!foodName || !foodCategory || !foodPrice || !foodImagePreview){
          ...
          <div className="step-2">
            ...
            <div className="form-group">
              <label for="food-category">Food Category</label>
                <select name="category" id="food-category" className="food-category">
                    ...
                    <option value="food-category">Grilled Foods</option>
                    <option value="food-category">Coffee</option>
