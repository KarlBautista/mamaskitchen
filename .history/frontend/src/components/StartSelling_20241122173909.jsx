  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      // Add food items to the store's table
        ...
        foodFormData.append("category", food.description);
        foodFormData.append("price", food.price);
        foodFormData.append("image", food.image);
        ...
        <div className="step-2-container">
          <div className="step-2">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Name of the food" id="food-name" onChange={foodHandleChange} name="name"/>
            </div>
            <div className="form-group">
              <label htmlFor="food-category">Food Category</label>
                <select name="category" id="food-category" className="food-category" onChange={foodHandleChange} value={selectedCategory}>
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Price of the food" id="food-price" onChange={foodHandleChange} name="price"/>
            </div>
            <div className="form-group">
