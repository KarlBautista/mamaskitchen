...
const StartSelling = () => {
  ...
  const handleLogoChange = (e) => {
    ...
    if (file) {
      setLogoPreview(URL.createObjectURL(file)); // Optional: for preview
  ...
  const handleBackgroundChange = (e) => {
    const file = e.target.files[0];
    if (file) {
      setBackgroundPreview(URL.createObjectURL(file)); // Optional: for preview
  ...
  const handleClick = async (e) => {
    ...
    formData.append("business_logo", storeInfo.businessLogo); // Incorrect
    formData.append("business_background", storeInfo.businessBackground); // Incorrect
