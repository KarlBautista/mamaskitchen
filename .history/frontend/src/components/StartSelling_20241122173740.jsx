        ...
        <div className="step-2-container">
          <div className="step-2">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Name of the food" id="food-name" onChange={foodHandleChange}/>
            </div>
            <div className="form-group">
              <label htmlFor="food-category">Food Category</label>
                <select name="category" id="food-category" className="food-category" onChange={onChange={foodHandleChange}} value={selectedCategory}>
