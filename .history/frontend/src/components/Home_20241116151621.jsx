                ...
                <div className="what-we-do">    
                    <div className="what-we-do-background">
                        ...
                        <div className="what-we-do-title">
                           <p>what we do</p>
                           <div className="line-1"></div>
                           <p className='what-we-do'>Foodly connects customers to their favorite foods with exclusive special offers and discounts, making every craving just a tap away!</p>
                        </div>
