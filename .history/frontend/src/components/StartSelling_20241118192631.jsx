        ...
        <div className="step-1-container">
          <div className="step-1">
            ...
            <div className="form-group">
              <label>Email</label>
              <input type="email" placeholder="Your Email" onChange={handleChange} name="email" value={storeInfo.} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Name of your store" onChange={handleChange} />
            </div>

            <div className="form-group">
              <label htmlFor="">Business Category</label>
              <select name="business-category" id="buisness-category" onChange={handleChange}>
