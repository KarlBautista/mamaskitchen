...
const handleClick = async (e) => {
  ...
  const businessCategory = document.querySelector("select[name='businessCategory']").value;
  const business_logo = document.querySelector("input[name='business_logo']").files[0];
  const business_background = document.querySelector("input[name='business_background']").files[0];


  try{
    await axios.post("http://localhost:8800/registered_account", {
  }
