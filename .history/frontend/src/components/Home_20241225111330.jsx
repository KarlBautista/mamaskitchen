...
import whatWeStandFor from "../images/whatWeStandFor.jpg";
...
function Home() {
    ...
    useEffect(() => {
        ...
        const user = localStorage.getItem('user'); // Example: Fetch user info from localStorage
        setIsLoggedIn(!!user);
    }, []);
    ...
    const handleButtonClick = (path) => {
        if (!isLoggedIn) {
            ...
            navigate('/search-cravings'; // Redirect to the desired page
        }
    };
            ...
            style={{
                ...
                <div className="what-we-do">    
                    <div className="what-we-do-background">
                        ...
                        <div className="what-we-do-title-container">
                           ...
                           <div className="line-1"></div>
                           <p className='what-we-do-title-message'>Mama's Kitchen celebrates the rich flavors of Filipino cuisine, connecting food lovers with authentic Pinoy dishes crafted with love and tradition. From savory classics to sweet delights, we make every meal feel like home.</p>
                        </div>
                ...
                <div className="what-we-do-background">
                        ...
                        <div className="what-we-do-title-container">
                           ...
                           <div className="line-1"></div>
                           <p className='what-we-do-title-message'>At Mama's Kitchen, we believe in preserving the essence of Filipino culture through food. Our platform supports local cooks and food enthusiasts, bringing you closer to the comfort and joy of home-cooked meals.</p>
                        </div>
