...
const StartSelling = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      // Clear all inputs and state variables after successful deployment
      setStoreInfo({
        email: "",
        password: "",
        businessName: "",
      ...
      document.getElementById("buisness-category").value = "";
        ...
        <div className="step-1-container">
          <div className="step-1">
            ...
            <div className="form-group">
              ...
              <select name="businessCategory" id="buisness-category" onChange={handleChange}  Name="businessCategory" value={storeInfo.businessCategory} >
