...
const AdminMenu = () => {
  ...
  const handleUpdate = async (foodId) => {
    try {
      const response = await axios.get(`http://localhost:8800/foods/${foodId}`);
      if (response.data.success) {
        ...
        Swal.fire({
          ...
          html: `
            ...
            <img src="http://localhost:8800${food.image_url}" alt="${food.name}" style="width: 100px; height: 100px; margin-top: 10px;">
          ...
          preConfirm: () => {
            ...
            // Update the dish
            updateDish(foodId, name, price, category, imageFile);
          },
        });
      } else {
        Swal.fire("Error", "Failed to fetch food item.", "error");
      }
    } catch (error) {
      console.error("Error fetching food item:", error);
      Swal.fire("Error", "An error occurred while fetching the food item.", "error");
    }
  };
                ...
                <div className="card-foods">
                  ...
                  <div className="card-details">
                    ...
                    <div className="dish-actions">
                      <button className="update-btn" onClick={() => handleUpdate(food.id)}>
                        Update
                      </button>
