  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      for (const item of food) {
        ...
        foodFormData.append("name", item.name);
        foodFormData.append("category", item.description);
        foodFormData.append("price", item.price);
        foodFormData.append("image", item.image);
  
        await axios.post(`http://localhost:8800/store_food/${storeId}`, foodFormData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
