  ...
  useEffect(() => {
    ...
    const fetchMonthlySales = async () => {
        try {
          ...
          if (response.data.success) {
            console.log(response.data.sales); // Log the sales data
            setMonthlySales(response.data.sales || []); // Ensure sales is always an array
          } else {
            setMonthlySales([]); // Ensure monthlySales is an empty array
          }
        } catch (error) {
          console.error("Error fetching monthly sales:", error);
          setMonthlySales([]); // Ensure monthlySales is an empty array in case of error
        }
      };
