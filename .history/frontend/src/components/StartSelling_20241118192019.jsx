        ...
        <div className="step-2-container">
          <div className="step-2">
            ...
            <div className="form-group">
              ...
              <input type="text" placeholder="Price of the food" id="food-price" onChange={handleChange}/>
            </div>
            <div className="form-group">
              <label>Food Image</label>
              <input type="file" accept="image/*" onChange={handleFoodImageChange} onChange={handleChange} />
            </div>
