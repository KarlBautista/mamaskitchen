  ...
  const addDish = async (name, price, category, imageFile) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setSearchQuery(""); // Reset search query after adding a dish
      } else {
        Swal.fire({
          icon: "error",
          title: "Error",
      ...
      if (result.isConfirmed) {
        try {
          ...
          if (response.data.success) {
            ...
            setSearchQuery(""); // Reset search query after deleting a dish
          } else {
            Swal.fire({
              icon: "error",
              title: "Error",
  ...
  const updateDish = async (id, name, price, category, imageFile) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setSearchQuery(""); // Reset search query after updating a dish
      } else {
        Swal.fire({
          icon: "error",
          title: "Error",
