...
const StartSelling = () => {
  ...
  const addFood = () => {
    const foodName = document.querySelector('input[placeholder="Name of the food"]').value;
    const foodDescription = document.querySelector('input[placeholder="Description of the food"]').value;
    const foodPrice = document.querySelector('input[placeholder="Price of the food"]').value;

    if (!foodName || !foodDescription || !foodPrice || !foodImagePreview) {
      alert("Please fill all the fields and upload a food image.");
      return;
    }
    ...
    // Reset the input fields and image preview
    document.querySelector('input[placeholder="Name of the food"]').value = "";
    document.querySelector('input[placeholder="Description of the food"]').value = "";
    document.querySelector('input[placeholder="Price of the food"]').value = "";
    setFoodImage(null);
